    ...
    <div className="flex-1 pb-10">
      ...
      <div className="px-6 mt-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm mt-1">Manage committee members and their roles</p>
          </div>
        </div>
      </div>
      ...
      {loading && !filteredData.length && !showAddForm && !editingItem && (
        <div className="px-6 mt-4 text-center py-20">
          ...
          <p className="text-gray-600 mt-2">Loading committee members...</p>
        </div>
      )}
        ...
        <div className="px-6 mt-4 space-y-4">
          {!loading && filteredData.length > 0 ? (
            ...
            <div className="text-center py-20">
              ...
              <h3 className="text-gray-800 font-bold">No committee members found</h3>
              <p className="text-gray-500 text-sm mt-1">Try adding a new committee member or searching with different keywords</p>
            </div>
          ) : null}
