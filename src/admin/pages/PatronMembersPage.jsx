    ...
    <div className="flex-1 pb-10">
      ...
      <div className="px-6 mt-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-800">Patron Members</h2>
            <p className="text-gray-600 text-sm mt-1">Manage patron members and their details</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 mt-4">
        <div className="bg-gray-50 rounded-2xl p-2 flex items-center gap-3 border border-gray-200 focus-within:border-indigo-300 transition-all shadow-sm">
          ...
          <input
            type="text"
            placeholder="Search patron members..."
            value={searchQuery}
      ...
      {loading && !filteredData.length && !showAddForm && !editingItem && (
        <div className="px-6 mt-4 text-center py-20">
          ...
          <p className="text-gray-600 mt-2">Loading patron members...</p>
        </div>
      )}
        ...
        <div className="px-6 mt-4 space-y-4">
          {!loading && filteredData.length > 0 ? (
            ...
            <div className="text-center py-20">
              ...
              <h3 className="text-gray-800 font-bold">No patron members found</h3>
              <p className="text-gray-500 text-sm mt-1">Try adding a new patron member or searching with different keywords</p>
            </div>
          ) : null}
